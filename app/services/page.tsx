  ...
  return (
    <main className="container py-20">
      ...
      <div className="text-center mt-16 bg-soft-gradient rounded-2xl py-12 px-6">
        ...
        <p className="text-gray-600 mt-2">Tell us what you want to build — we’ll guide you.</p>
        <Link href="/contact" className="btn-primary mt-6 inline-block">Request a Meeting</Link>
      </div>
